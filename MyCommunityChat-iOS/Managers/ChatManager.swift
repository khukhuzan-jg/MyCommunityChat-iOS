...
extension ChatManager : ChatManagerProtocol {
        ...
        self.ref.child(Conversation.conversations.getValue())
            ...
            .observeSingleEvent(of: .value) { snapshot in
                ...
                var message = Message()
                    ...
                    message.gif = childSnapshot.childSnapshot(forPath: "gif").value as? String
    ...
    func sendMessage(senderId : String , receiverId : String,  message : Message , completion : (_ message : Message) -> Void) {
        ...
        let sendMessage = [
            ...
            "updatedAt" : Date().toString(.type38 , timeZone: TimeZone.current.localizedName(for: .standard, locale: .current) ?? "MM"),
